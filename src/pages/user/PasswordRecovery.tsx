                ...
                <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl shadow-2xl p-6">
                    ...
                    <div className="flex justify-center mb-4">
                        <div className="inline-flex rounded-full bg-[#45d2fd]/20 p-3">
                            <LockClosedIcon className="h-8 w-8 text-[#45d2fd]" />
                        </div>
                    </div>
                    ...
                    {success ? (
                        ...
                        <div className="py-4">
                            ...
                            <Link
                                to="/"
                                className="block w-full text-center bg-[#45d2fd] hover:bg-[#22b8d9] text-gray-900 font-semibold py-2 rounded-lg transition-colors duration-200 text-sm"
                            >
                                Go to Home
                            </Link>
                        </div>
