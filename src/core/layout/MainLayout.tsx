...
function MainLayout() {
    ...
    const gradientFrom = effectiveTheme === 'dark' ? '#230c77' : '#67e8f9';
                ...
                >
                    <div
                        style={{
                            ...
                            backgroundImage: `linear-gradient(to top right, ${gradientFrom}, #45d2fd)`,
                        }}
                        className="relative -top-40  left-25 -z-10 aspect-[1/1] w-[150%] sm:w-[150%] lg:w-[120%] max-w-none rotate-[50deg] opacity-30 md:opacity-20"
                    />
                </div>
